...
export const CHARACTER_CLASSES = {
  BALANCED: {
    ...
    passive: {
      name: 'Versatility',
      description: 'Gain +5% to all stats for each different action type used (attack, skill, defend, item)',
      icon: '✨',
    },
  ...
  WARRIOR: {
    ...
    stats: {
      ...
      critChance: 0.20,      // 20% crit chance (higher)
      critDamage: 1.75,      // 175% crit damage (higher)
    },
    
    passive: {
      name: 'Battle Fury',
      description: 'Critical hits reduce skill cooldowns by 1 turn and grant +10% damage for next attack',
      icon: '🔥',
    },
  ...
  TANK: {
    ...
    stats: {
      ...
      critChance: 0.10,      // 10% crit chance (lower)
      critDamage: 1.25,      // 125% crit damage (lower)
    },
    
    passive: {
      name: 'Iron Will',
      description: 'Defending grants a shield that absorbs 30% of next damage taken. Heal 5% max HP each turn.',
      icon: '🛡️',
    },
    
    mechanics: {
      skillCostReduction: 0,
      defendBonus: 0.30,     // 30% more damage reduction when defending (total 80%)
      comboBonus: 0,
      healingBonus: 0.20,    // 20% more healing from items
    },
  },
  ...
  GLASS_CANNON: {
    ...
    mechanics: {
      skillCostReduction: 0.30,  // 30% less mana cost
      defendBonus: -0.20,    // 20% less effective defend
      comboBonus: 0.08,      // +8% damage per combo hit
      healingBonus: -0.10,   // 10% less healing
    },
  },
  ...
  BRUISER: {
    ...
    mechanics: {
      skillCostReduction: 0,
      defendBonus: 0.10,     // 10% more effective defend
      comboBonus: 0,
  ...
  MAGE: {
    ...
    passive: {
      name: 'Arcane Power',
      description: 'Skills deal 30% more damage. Using a skill grants +20% damage on next basic attack.',
      icon: '✨',
    },
    
    mechanics: {
      skillCostReduction: 0.20,  // 20% less mana cost
      defendBonus: 0,
      comboBonus: 0,
      healingBonus: 0,
    },
  ...
  ASSASSIN: {
    ...
    stats: {
      ...
      critChance: 0.30,      // 30% crit chance (highest)
      critDamage: 2.2,       // 220% crit damage
    },
    
    passive: {
      name: 'First Strike',
      description: 'First attack each combat deals double damage. Each attack has 15% chance to attack again immediately.',
      icon: '⚡',
    },
    ...
    mechanics: {
      ...
      comboBonus: 0.10,      // +10% damage per combo hit (highest)
      healingBonus: 0,
    },
  },
  ...
  BERSERKER: {
    ...
    passive: {
      name: 'Rage',
      description: 'Gain 3% damage and 1% crit chance for every 10% HP missing. Taking damage grants +5 mana.',
      icon: '😡',
    },
    ...
    mechanics: {
      ...
      healingBonus: -0.20,   // 20% less healing (rage over recovery)
    },
  },
  ...
  PALADIN: {
    ...
    mechanics: {
      skillCostReduction: 0.10,
      defendBonus: 0.15,     // 15% more effective defend
      comboBonus: 0,
      healingBonus: 0.40,    // 40% more healing (highest)
    },
  },
  ...
  NECROMANCER: {
    ...
    passive: {
      name: 'Life Drain',
      description: 'Heal for 15% of skill damage dealt. Defeating enemies permanently increases max HP by 5%.',
      icon: '🩸',
    },
